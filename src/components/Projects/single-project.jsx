...
import placeholder from '../../../public/placeholder.png'; // Adjust path based on your Vite project structure

const SingleProject = ({ project }) => {
  const { name, description, tags, code, demo, image } = project;

  return (
   <div className="group w-full h-fit flex flex-col items-center justify-center relative cursor-text overflow-hidden px-3 md:px-8 py-[1.4rem] bg-[#201435] shadow-2xl rounded-lg border border-[#1a1443]">
